function [planes,actions] = generateModel33(p_obs_states, rewards)
...
unix('unset LD_LIBRARY_PATH;pomdpsol_APPL test.pomdp --timeout 0.1 --output out.policy > /dev/null');
